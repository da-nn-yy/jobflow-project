"""Generated field-service playbook 46."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_46 = PlaybookDefinition(
    id="playbook_46",
    name="Regional playbook 46",
    description="Multi-step field workflow for hvac region 14.",
    tasks=[
    ...
    metadata={"region": "14", "vertical": "hvac"},
)
