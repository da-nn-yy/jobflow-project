"""Generated field-service playbook 74."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_74 = PlaybookDefinition(
    id="playbook_74",
    name="Regional playbook 74",
    description="Multi-step field workflow for facilities region 10.",
    tasks=[
    ...
    metadata={"region": "10", "vertical": "facilities"},
)
