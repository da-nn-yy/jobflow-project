"""Generated field-service playbook 30."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_30 = PlaybookDefinition(
    id="playbook_30",
    name="Regional playbook 30",
    description="Multi-step field workflow for appliance region 14.",
    tasks=[
    ...
    metadata={"region": "14", "vertical": "appliance"},
)
