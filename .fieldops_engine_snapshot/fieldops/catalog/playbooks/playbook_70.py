"""Generated field-service playbook 70."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_70 = PlaybookDefinition(
    id="playbook_70",
    name="Regional playbook 70",
    description="Multi-step field workflow for appliance region 6.",
    tasks=[
    ...
    metadata={"region": "6", "vertical": "appliance"},
)
