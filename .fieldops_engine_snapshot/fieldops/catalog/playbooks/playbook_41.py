"""Generated field-service playbook 41."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_41 = PlaybookDefinition(
    id="playbook_41",
    name="Regional playbook 41",
    description="Multi-step field workflow for hvac region 9.",
    tasks=[
    ...
    metadata={"region": "9", "vertical": "hvac"},
)
