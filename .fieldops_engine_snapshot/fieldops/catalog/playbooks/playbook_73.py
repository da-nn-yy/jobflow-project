"""Generated field-service playbook 73."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_73 = PlaybookDefinition(
    id="playbook_73",
    name="Regional playbook 73",
    description="Multi-step field workflow for electrical region 9.",
    tasks=[
    ...
    metadata={"region": "9", "vertical": "electrical"},
)
