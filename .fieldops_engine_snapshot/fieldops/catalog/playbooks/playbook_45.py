"""Generated field-service playbook 45."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_45 = PlaybookDefinition(
    id="playbook_45",
    name="Regional playbook 45",
    description="Multi-step field workflow for appliance region 13.",
    tasks=[
    ...
    metadata={"region": "13", "vertical": "appliance"},
)
