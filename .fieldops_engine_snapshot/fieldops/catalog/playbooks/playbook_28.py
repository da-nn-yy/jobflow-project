"""Generated field-service playbook 28."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_28 = PlaybookDefinition(
    id="playbook_28",
    name="Regional playbook 28",
    description="Multi-step field workflow for electrical region 12.",
    tasks=[
    ...
    metadata={"region": "12", "vertical": "electrical"},
)
