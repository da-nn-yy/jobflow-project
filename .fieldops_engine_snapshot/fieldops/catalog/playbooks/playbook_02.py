"""Generated field-service playbook 2."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_02 = PlaybookDefinition(
    id="playbook_02",
    name="Regional playbook 2",
    description="Multi-step field workflow for plumbing region 2.",
    tasks=[
    ...
    metadata={"region": "2", "vertical": "plumbing"},
)
