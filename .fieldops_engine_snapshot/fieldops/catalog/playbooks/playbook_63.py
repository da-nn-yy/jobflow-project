"""Generated field-service playbook 63."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_63 = PlaybookDefinition(
    id="playbook_63",
    name="Regional playbook 63",
    description="Multi-step field workflow for electrical region 15.",
    tasks=[
    ...
    metadata={"region": "15", "vertical": "electrical"},
)
