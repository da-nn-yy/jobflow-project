"""Generated field-service playbook 69."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_69 = PlaybookDefinition(
    id="playbook_69",
    name="Regional playbook 69",
    description="Multi-step field workflow for facilities region 5.",
    tasks=[
    ...
    metadata={"region": "5", "vertical": "facilities"},
)
