"""Generated field-service playbook 17."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_17 = PlaybookDefinition(
    id="playbook_17",
    name="Regional playbook 17",
    description="Multi-step field workflow for plumbing region 1.",
    tasks=[
    ...
    metadata={"region": "1", "vertical": "plumbing"},
)
