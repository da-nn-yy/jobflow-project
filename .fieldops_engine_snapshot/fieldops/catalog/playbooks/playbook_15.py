"""Generated field-service playbook 15."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_15 = PlaybookDefinition(
    id="playbook_15",
    name="Regional playbook 15",
    description="Multi-step field workflow for appliance region 15.",
    tasks=[
    ...
    metadata={"region": "15", "vertical": "appliance"},
)
