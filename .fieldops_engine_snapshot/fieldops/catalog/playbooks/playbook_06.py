"""Generated field-service playbook 6."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_06 = PlaybookDefinition(
    id="playbook_06",
    name="Regional playbook 6",
    description="Multi-step field workflow for hvac region 6.",
    tasks=[
    ...
    metadata={"region": "6", "vertical": "hvac"},
)
