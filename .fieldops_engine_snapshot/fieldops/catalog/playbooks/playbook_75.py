"""Generated field-service playbook 75."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_75 = PlaybookDefinition(
    id="playbook_75",
    name="Regional playbook 75",
    description="Multi-step field workflow for appliance region 11.",
    tasks=[
    ...
    metadata={"region": "11", "vertical": "appliance"},
)
