"""Generated field-service playbook 65."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_65 = PlaybookDefinition(
    id="playbook_65",
    name="Regional playbook 65",
    description="Multi-step field workflow for appliance region 1.",
    tasks=[
    ...
    metadata={"region": "1", "vertical": "appliance"},
)
