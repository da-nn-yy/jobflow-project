"""Generated field-service playbook 32."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_32 = PlaybookDefinition(
    id="playbook_32",
    name="Regional playbook 32",
    description="Multi-step field workflow for plumbing region 16.",
    tasks=[
    ...
    metadata={"region": "16", "vertical": "plumbing"},
)
