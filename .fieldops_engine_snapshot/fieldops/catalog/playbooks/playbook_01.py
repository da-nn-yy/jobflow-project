"""Generated field-service playbook 1."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_01 = PlaybookDefinition(
    id="playbook_01",
    name="Regional playbook 1",
    description="Multi-step field workflow for hvac region 1.",
    tasks=[
    ...
    metadata={"region": "1", "vertical": "hvac"},
)
