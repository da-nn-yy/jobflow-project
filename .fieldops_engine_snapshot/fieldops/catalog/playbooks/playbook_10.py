"""Generated field-service playbook 10."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_10 = PlaybookDefinition(
    id="playbook_10",
    name="Regional playbook 10",
    description="Multi-step field workflow for appliance region 10.",
    tasks=[
    ...
    metadata={"region": "10", "vertical": "appliance"},
)
