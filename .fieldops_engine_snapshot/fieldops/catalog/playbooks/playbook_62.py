"""Generated field-service playbook 62."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_62 = PlaybookDefinition(
    id="playbook_62",
    name="Regional playbook 62",
    description="Multi-step field workflow for plumbing region 14.",
    tasks=[
    ...
    metadata={"region": "14", "vertical": "plumbing"},
)
