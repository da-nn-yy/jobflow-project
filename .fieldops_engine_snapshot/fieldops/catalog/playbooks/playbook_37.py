"""Generated field-service playbook 37."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_37 = PlaybookDefinition(
    id="playbook_37",
    name="Regional playbook 37",
    description="Multi-step field workflow for plumbing region 5.",
    tasks=[
    ...
    metadata={"region": "5", "vertical": "plumbing"},
)
