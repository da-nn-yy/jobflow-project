"""Generated field-service playbook 40."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_40 = PlaybookDefinition(
    id="playbook_40",
    name="Regional playbook 40",
    description="Multi-step field workflow for appliance region 8.",
    tasks=[
    ...
    metadata={"region": "8", "vertical": "appliance"},
)
