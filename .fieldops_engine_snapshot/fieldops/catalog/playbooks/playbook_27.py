"""Generated field-service playbook 27."""
from fieldops.domain.models import PlaybookDefinition, TaskDefinition

PLAYBOOK_27 = PlaybookDefinition(
    id="playbook_27",
    name="Regional playbook 27",
    description="Multi-step field workflow for plumbing region 11.",
    tasks=[
    ...
    metadata={"region": "11", "vertical": "plumbing"},
)
