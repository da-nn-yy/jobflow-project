...
/** Enterprise workflow pack 20: multi-stage finance pipeline with validation gates. */
export const JobEnterprise20: JobDefinition = {
  id: asJobId('enterprise_job_20'),
  name: 'Enterprise workflow 20',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '20', tier: 'enterprise' },
