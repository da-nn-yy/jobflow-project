...
/** Enterprise workflow pack 12: multi-stage finance pipeline with validation gates. */
export const JobEnterprise12: JobDefinition = {
  id: asJobId('enterprise_job_12'),
  name: 'Enterprise workflow 12',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '12', tier: 'enterprise' },
