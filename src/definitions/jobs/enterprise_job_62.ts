...
/** Enterprise workflow pack 62: multi-stage finance pipeline with validation gates. */
export const JobEnterprise62: JobDefinition = {
  id: asJobId('enterprise_job_62'),
  name: 'Enterprise workflow 62',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '62', tier: 'enterprise' },
