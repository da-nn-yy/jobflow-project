...
/** Enterprise workflow pack 52: multi-stage finance pipeline with validation gates. */
export const JobEnterprise52: JobDefinition = {
  id: asJobId('enterprise_job_52'),
  name: 'Enterprise workflow 52',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '52', tier: 'enterprise' },
