...
/** Enterprise workflow pack 38: multi-stage finance pipeline with validation gates. */
export const JobEnterprise38: JobDefinition = {
  id: asJobId('enterprise_job_38'),
  name: 'Enterprise workflow 38',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '38', tier: 'enterprise' },
