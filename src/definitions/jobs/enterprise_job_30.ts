...
/** Enterprise workflow pack 30: multi-stage finance pipeline with validation gates. */
export const JobEnterprise30: JobDefinition = {
  id: asJobId('enterprise_job_30'),
  name: 'Enterprise workflow 30',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '30', tier: 'enterprise' },
