...
/** Enterprise workflow pack 28: multi-stage finance pipeline with validation gates. */
export const JobEnterprise28: JobDefinition = {
  id: asJobId('enterprise_job_28'),
  name: 'Enterprise workflow 28',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '28', tier: 'enterprise' },
