...
/** Enterprise workflow pack 4: multi-stage finance pipeline with validation gates. */
export const JobEnterprise04: JobDefinition = {
  id: asJobId('enterprise_job_04'),
  name: 'Enterprise workflow 4',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '4', tier: 'enterprise' },
