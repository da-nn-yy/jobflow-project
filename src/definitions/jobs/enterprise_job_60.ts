...
/** Enterprise workflow pack 60: multi-stage finance pipeline with validation gates. */
export const JobEnterprise60: JobDefinition = {
  id: asJobId('enterprise_job_60'),
  name: 'Enterprise workflow 60',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '60', tier: 'enterprise' },
