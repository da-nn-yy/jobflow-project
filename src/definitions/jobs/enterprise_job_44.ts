...
/** Enterprise workflow pack 44: multi-stage finance pipeline with validation gates. */
export const JobEnterprise44: JobDefinition = {
  id: asJobId('enterprise_job_44'),
  name: 'Enterprise workflow 44',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '44', tier: 'enterprise' },
