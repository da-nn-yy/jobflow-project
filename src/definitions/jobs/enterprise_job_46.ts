...
/** Enterprise workflow pack 46: multi-stage finance pipeline with validation gates. */
export const JobEnterprise46: JobDefinition = {
  id: asJobId('enterprise_job_46'),
  name: 'Enterprise workflow 46',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '46', tier: 'enterprise' },
