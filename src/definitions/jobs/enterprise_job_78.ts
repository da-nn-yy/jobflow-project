...
/** Enterprise workflow pack 78: multi-stage finance pipeline with validation gates. */
export const JobEnterprise78: JobDefinition = {
  id: asJobId('enterprise_job_78'),
  name: 'Enterprise workflow 78',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '78', tier: 'enterprise' },
