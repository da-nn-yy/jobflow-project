...
/** Enterprise workflow pack 68: multi-stage finance pipeline with validation gates. */
export const JobEnterprise68: JobDefinition = {
  id: asJobId('enterprise_job_68'),
  name: 'Enterprise workflow 68',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '68', tier: 'enterprise' },
