...
/** Enterprise workflow pack 6: multi-stage finance pipeline with validation gates. */
export const JobEnterprise06: JobDefinition = {
  id: asJobId('enterprise_job_06'),
  name: 'Enterprise workflow 6',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '6', tier: 'enterprise' },
