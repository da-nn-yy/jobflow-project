...
/** Enterprise workflow pack 54: multi-stage finance pipeline with validation gates. */
export const JobEnterprise54: JobDefinition = {
  id: asJobId('enterprise_job_54'),
  name: 'Enterprise workflow 54',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '54', tier: 'enterprise' },
