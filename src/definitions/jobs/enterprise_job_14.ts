...
/** Enterprise workflow pack 14: multi-stage finance pipeline with validation gates. */
export const JobEnterprise14: JobDefinition = {
  id: asJobId('enterprise_job_14'),
  name: 'Enterprise workflow 14',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '14', tier: 'enterprise' },
