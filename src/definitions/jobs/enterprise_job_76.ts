...
/** Enterprise workflow pack 76: multi-stage finance pipeline with validation gates. */
export const JobEnterprise76: JobDefinition = {
  id: asJobId('enterprise_job_76'),
  name: 'Enterprise workflow 76',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '76', tier: 'enterprise' },
