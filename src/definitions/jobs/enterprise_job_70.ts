...
/** Enterprise workflow pack 70: multi-stage finance pipeline with validation gates. */
export const JobEnterprise70: JobDefinition = {
  id: asJobId('enterprise_job_70'),
  name: 'Enterprise workflow 70',
  version: 1,
  ...
  allowedTransitions: [],
  metadata: { domain: 'finance', pack: '70', tier: 'enterprise' },
